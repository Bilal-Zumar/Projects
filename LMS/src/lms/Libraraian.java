 ...
 * @author Bilal Zumar
 */
public class Libraraian extends javax.swing.JFrame {
    Library lib;
    Users user;
    /**
     *
    ...
    void setter(Library l,Users user){
        this.user=user;
        this.lib=l;
        ...
        ArrayList m=lib.hasbooks(user);
        if(m.isEmpty())
            m.add("You have taken no Book");
        javax.swing.JList<String> j= new javax.swing.JList(m.toArray());
...
//        this.setVisible(Boolean.FALSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Libraraian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Libraraian().setVisible(true);
            }
        });
    }
